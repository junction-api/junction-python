## 1.2.0 - 2026-05-15
### Added
* **`LabReportResultLoincMatchStatus`** — new enum type with values `AUTO_MATCH`, `NEEDS_REVIEW`, and `NO_MATCH` (non-exhaustive, with forward-compatible unknown value handling).
