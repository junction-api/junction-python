...
class MealColumnExprMeal(enum.StrEnum):
    ...
    OMEGA3FAT_GRAM = "omega3_fat_gram"
    OMEGA6FAT_GRAM = "omega6_fat_gram"
    ...
    VITAMIN_B1MILLIGRAM = "vitamin_b1_milligram"
    ...
    VITAMIN_B6MILLIGRAM = "vitamin_b6_milligram"
    BIOTIN_MICROGRAM = "biotin_microgram"
    VITAMIN_B12MICROGRAM = "vitamin_b12_microgram"
    ...
    def visit(
        ...
        omega3fat_gram: typing.Callable[[], T_Result],
        omega6fat_gram: typing.Callable[[], T_Result],
        ...
        vitamin_b1milligram: typing.Callable[[], T_Result],
        ...
        vitamin_b6milligram: typing.Callable[[], T_Result],
        biotin_microgram: typing.Callable[[], T_Result],
        vitamin_b12microgram: typing.Callable[[], T_Result],
        ...
        if self is MealColumnExprMeal.OMEGA3FAT_GRAM:
            return omega3fat_gram()
        if self is MealColumnExprMeal.OMEGA6FAT_GRAM:
            return omega6fat_gram()
        ...
        if self is MealColumnExprMeal.VITAMIN_B1MILLIGRAM:
            return vitamin_b1milligram()
        ...
        if self is MealColumnExprMeal.VITAMIN_B6MILLIGRAM:
            return vitamin_b6milligram()
        if self is MealColumnExprMeal.BIOTIN_MICROGRAM:
            return biotin_microgram()
        if self is MealColumnExprMeal.VITAMIN_B12MICROGRAM:
            return vitamin_b12microgram()
