...
class ClientFacingResource(enum.StrEnum):
    ...
    FORCED_EXPIRATORY_VOLUME1 = "forced_expiratory_volume_1"
    ...
    def visit(
        ...
        result_table: typing.Callable[[], T_Result],
        ...
        vo2max: typing.Callable[[], T_Result],
        ...
        forced_expiratory_volume1: typing.Callable[[], T_Result],
        ...
        if self is ClientFacingResource.APPOINTMENT:
            return appointment()
        if self is ClientFacingResource.RESULT_TABLE:
            return result_table()
        ...
        if self is ClientFacingResource.VO2MAX:
            return vo2max()
        ...
        if self is ClientFacingResource.FORCED_EXPIRATORY_VOLUME1:
            return forced_expiratory_volume1()
