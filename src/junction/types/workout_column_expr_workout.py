...
class WorkoutColumnExprWorkout(enum.StrEnum):
    ...
    HEART_RATE_ZONE1 = "heart_rate_zone_1"
    HEART_RATE_ZONE2 = "heart_rate_zone_2"
    HEART_RATE_ZONE3 = "heart_rate_zone_3"
    HEART_RATE_ZONE4 = "heart_rate_zone_4"
    HEART_RATE_ZONE5 = "heart_rate_zone_5"
    HEART_RATE_ZONE6 = "heart_rate_zone_6"
    ...
    def visit(
        ...
        heart_rate_zone1: typing.Callable[[], T_Result],
        heart_rate_zone2: typing.Callable[[], T_Result],
        heart_rate_zone3: typing.Callable[[], T_Result],
        heart_rate_zone4: typing.Callable[[], T_Result],
        heart_rate_zone5: typing.Callable[[], T_Result],
        heart_rate_zone6: typing.Callable[[], T_Result],
        ...
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE1:
            return heart_rate_zone1()
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE2:
            return heart_rate_zone2()
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE3:
            return heart_rate_zone3()
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE4:
            return heart_rate_zone4()
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE5:
            return heart_rate_zone5()
        if self is WorkoutColumnExprWorkout.HEART_RATE_ZONE6:
            return heart_rate_zone6()
