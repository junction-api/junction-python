...
if typing.TYPE_CHECKING:
    ...
    from .client_facing_forced_expiratory_volume1changed import ClientFacingForcedExpiratoryVolume1Changed
    from .client_facing_forced_expiratory_volume1changed_event_type import (
        ClientFacingForcedExpiratoryVolume1ChangedEventType,
    )
    from .client_facing_forced_expiratory_volume1historical_pull_completed import (
        ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted,
    )
    from .client_facing_forced_expiratory_volume1sample import ClientFacingForcedExpiratoryVolume1Sample
    ...
    from .client_facing_vo2max_changed import ClientFacingVo2MaxChanged
    from .client_facing_vo2max_changed_event_type import ClientFacingVo2MaxChangedEventType
    from .client_facing_vo2max_historical_pull_completed import ClientFacingVo2MaxHistoricalPullCompleted
    from .client_facing_vo2max_timeseries import ClientFacingVo2MaxTimeseries
    ...
    from .grouped_forced_expiratory_volume1 import GroupedForcedExpiratoryVolume1
    from .grouped_forced_expiratory_volume1response import GroupedForcedExpiratoryVolume1Response
    ...
    from .grouped_vo2max import GroupedVo2Max
    from .grouped_vo2max_response import GroupedVo2MaxResponse
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ClientFacingForcedExpiratoryVolume1Changed": ".client_facing_forced_expiratory_volume1changed",
    "ClientFacingForcedExpiratoryVolume1ChangedEventType": ".client_facing_forced_expiratory_volume1changed_event_type",
    "ClientFacingForcedExpiratoryVolume1HistoricalPullCompleted": ".client_facing_forced_expiratory_volume1historical_pull_completed",
    "ClientFacingForcedExpiratoryVolume1Sample": ".client_facing_forced_expiratory_volume1sample",
    ...
    "ClientFacingVo2MaxChanged": ".client_facing_vo2max_changed",
    "ClientFacingVo2MaxChangedEventType": ".client_facing_vo2max_changed_event_type",
    "ClientFacingVo2MaxHistoricalPullCompleted": ".client_facing_vo2max_historical_pull_completed",
    "ClientFacingVo2MaxTimeseries": ".client_facing_vo2max_timeseries",
    ...
    "GroupedForcedExpiratoryVolume1": ".grouped_forced_expiratory_volume1",
    "GroupedForcedExpiratoryVolume1Response": ".grouped_forced_expiratory_volume1response",
    ...
    "GroupedVo2Max": ".grouped_vo2max",
    "GroupedVo2MaxResponse": ".grouped_vo2max_response",
