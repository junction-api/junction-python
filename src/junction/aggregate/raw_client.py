...
class RawAggregateClient:
    ...
    def query_one(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"aggregate/v1/user/{encode_path_param(user_id)}/query",
            method="POST",
            json={
                "timeframe": timeframe,
                "queries": queries,
    ...
    def get_result_table_for_continuous_query(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"aggregate/v1/user/{encode_path_param(user_id)}/continuous_query/{encode_path_param(query_id_or_slug)}/result_table",
            method="GET",
            headers={
                "accept": "*/*",
            },
    ...
    def get_task_history_for_continuous_query(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"aggregate/v1/user/{encode_path_param(user_id)}/continuous_query/{encode_path_param(query_id_or_slug)}/task_history",
            method="GET",
            params={
