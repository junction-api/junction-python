...
class RawLinkClient:
    ...
    def generate_oauth_link(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/link/provider/oauth/{encode_path_param(oauth_provider)}",
            method="GET",
            headers={
    ...
    def connect_password_provider(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/link/provider/password/{encode_path_param(provider)}",
            method="POST",
            json={
                "username": username,
                "password": password,
    ...
    def complete_password_provider_mfa(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/link/provider/password/{encode_path_param(provider)}/complete_mfa",
            method="POST",
            json={
                "mfa_code": mfa_code,
            },
