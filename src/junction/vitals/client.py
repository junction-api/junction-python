...
class VitalsClient:
    ...
    def forced_expiratory_volume1grouped(
        ...
        *,
        ...
        """
        _response = self._raw_client.forced_expiratory_volume1grouped(
            user_id,
            start_date=start_date,
            cursor=cursor,
            next_cursor=next_cursor,
    ...
    def vo2max_grouped(
        ...
        *,
        ...
        """
        _response = self._raw_client.vo2max_grouped(
            user_id,
            start_date=start_date,
            cursor=cursor,
            next_cursor=next_cursor,
    ...
    def vo2max(
        ...
        *,
        ...
        """
        _response = self._raw_client.vo2max(
...
class AsyncVitalsClient:
    ...
    async def forced_expiratory_volume1grouped(
        ...
        *,
        ...
        async def main() -> None:
            await client.vitals.forced_expiratory_volume1grouped(
                user_id="user_id",
                cursor="cursor",
                next_cursor="next_cursor",
                provider="provider",
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.forced_expiratory_volume1grouped(
            user_id,
            start_date=start_date,
            cursor=cursor,
            next_cursor=next_cursor,
    ...
    async def vo2max_grouped(
        ...
        *,
        ...
        async def main() -> None:
            await client.vitals.vo2max_grouped(
                user_id="user_id",
                cursor="cursor",
                next_cursor="next_cursor",
                provider="provider",
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.vo2max_grouped(
            user_id,
            start_date=start_date,
            cursor=cursor,
            next_cursor=next_cursor,
    ...
    async def vo2max(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.vo2max(
            user_id, start_date=start_date, provider=provider, end_date=end_date, request_options=request_options
        )
        return _response.data
