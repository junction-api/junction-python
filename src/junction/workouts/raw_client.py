...
class RawWorkoutsClient:
    ...
    def get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v2/summary/workouts/{encode_path_param(user_id)}",
            method="GET",
            params={
                "provider": provider,
    ...
    def get_raw(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/summary/workouts/{encode_path_param(user_id)}/raw",
            method="GET",
            params={
                "provider": provider,
                "start_date": start_date,
    ...
    def get_by_workout_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/timeseries/workouts/{encode_path_param(workout_id)}/stream",
            method="GET",
            request_options=request_options,
        )
        try:
