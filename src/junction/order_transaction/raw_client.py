...
class RawOrderTransactionClient:
    ...
    def get_transaction(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order_transaction/{encode_path_param(transaction_id)}",
            method="GET",
    ...
    def get_transaction_result(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order_transaction/{encode_path_param(transaction_id)}/result",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_transaction_result_pdf(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v3/order_transaction/{encode_path_param(transaction_id)}/result/pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
