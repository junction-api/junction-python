...
class Junction:
    ...
    environment : JunctionEnvironment
        The environment to use for requests from the client. from .environment import JunctionEnvironment



        Defaults to JunctionEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: JunctionEnvironment = JunctionEnvironment.PRODUCTION,
        api_key: str,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: JunctionEnvironment) -> str:
