...
_dynamic_imports: typing.Dict[str, str] = {
    "GetLabTestsRequestOrderDirection": ".get_lab_tests_request_order_direction",
    "GetLabTestsRequestOrderKey": ".get_lab_tests_request_order_key",
    "GetOrdersLabTestsRequestOrderDirection": ".get_orders_lab_tests_request_order_direction",
    "GetOrdersLabTestsRequestOrderKey": ".get_orders_lab_tests_request_order_key",
    "GetPaginatedLabTestsRequestOrderDirection": ".get_paginated_lab_tests_request_order_direction",
    "GetPaginatedLabTestsRequestOrderKey": ".get_paginated_lab_tests_request_order_key",
}
