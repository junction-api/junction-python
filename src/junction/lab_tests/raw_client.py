...
from ..types.add_on_order import AddOnOrder
...
class RawLabTestsClient:
    ...
    def get_by_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/lab_tests/{encode_path_param(lab_test_id)}",
            method="GET",
            params={
                "lab_account_id": lab_account_id,
            },
    ...
    def get_markers_for_order_set(
        ...
        *,
        ...
        lab_test_ids : typing.Optional[typing.Sequence[str]]
    ...
    def get_markers_for_lab_test(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/lab_tests/{encode_path_param(lab_test_id)}/markers",
            method="GET",
            params={
                "lab_account_id": lab_account_id,
                "page": page,
    ...
    def get_markers_by_lab_and_provider_id(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/lab_tests/{encode_path_param(lab_id)}/markers/{encode_path_param(provider_id)}",
            method="GET",
            params={
                "lab_account_id": lab_account_id,
            },
    ...
    def get_lab_test_collection_instruction_pdf(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v3/lab_test/{encode_path_param(lab_test_id)}/collection_instruction_pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def get_phlebotomy_appointment_availability(
        ...
        *,
        ...
        access_notes: typing.Optional[str] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        access_notes : typing.Optional[str]
    ...
    def book_phlebotomy_appointment(
        ...
        *,
        ...
        async_confirmation: typing.Optional[bool] = OMIT,
        sync_confirmation_timeout_millisecond: typing.Optional[int] = OMIT,
        async_confirmation_timeout_millisecond: typing.Optional[int] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        async_confirmation : typing.Optional[bool]
        ...
        sync_confirmation_timeout_millisecond : typing.Optional[int]
        ...
        async_confirmation_timeout_millisecond : typing.Optional[int]
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/phlebotomy/appointment/book",
            method="POST",
            json={
                "booking_key": booking_key,
                "appointment_notes": appointment_notes,
                "async_confirmation": async_confirmation,
                "sync_confirmation_timeout_millisecond": sync_confirmation_timeout_millisecond,
                "async_confirmation_timeout_millisecond": async_confirmation_timeout_millisecond,
            },
            headers={
                "content-type": "application/json",
            },
    ...
    def request_phlebotomy_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/phlebotomy/appointment/request",
            method="POST",
            json={
                "address": address,
                "provider": provider,
    ...
    def reschedule_phlebotomy_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/phlebotomy/appointment/reschedule",
            method="PATCH",
            json={
                "booking_key": booking_key,
                "appointment_notes": appointment_notes,
    ...
    def cancel_phlebotomy_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/phlebotomy/appointment/cancel",
            method="PATCH",
            json={
    ...
    def get_phlebotomy_appointment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/phlebotomy/appointment",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_order_psc_info(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/psc/info",
            method="GET",
            params={
                "radius": radius,
                "capabilities": capabilities,
    ...
    def get_result_pdf(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v3/order/{encode_path_param(order_id)}/result/pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def get_result_metadata(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/result/metadata",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_result_raw(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/result",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_labels_pdf(
        ...
        *,
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v3/order/{encode_path_param(order_id)}/labels/pdf",
            method="GET",
            params={
    ...
    def book_psc_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/psc/appointment/book",
            method="POST",
            json={
                "booking_key": booking_key,
                "appointment_notes": appointment_notes,
    ...
    def reschedule_psc_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/psc/appointment/reschedule",
            method="PATCH",
            json={
                "booking_key": booking_key,
                "appointment_notes": appointment_notes,
    ...
    def cancel_psc_appointment(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/psc/appointment/cancel",
            method="PATCH",
            json={
    ...
    def get_psc_appointment(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/psc/appointment",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_order_tracking(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/tracking",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    OrderTracking,
                    parse_obj_as(
                        type_=OrderTracking,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def get_order_collection_instruction_pdf(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v3/order/{encode_path_param(order_id)}/collection_instruction_pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def get_order_requistion_pdf(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v3/order/{encode_path_param(order_id)}/requisition/pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def get_order_abn_pdf(
        ...
        """
        with self._client_wrapper.httpx_client.stream(
            f"v3/order/{encode_path_param(order_id)}/abn_pdf",
            method="GET",
            request_options=request_options,
        ) as _response:
    ...
    def cancel_order(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/cancel",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def simulate_order_process(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/test",
            method="POST",
            params={
    ...
    def update_on_site_collection_order_draw_completed(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v3/order/{encode_path_param(order_id)}/draw_completed",
            method="PATCH",
            request_options=request_options,
        )
        try:
...
class AsyncRawLabTestsClient:
    ...
    async def get_order_tracking(
        self, order_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[OrderTracking]:
        """
        Get current estimates and immutable ETA update history for an order.
