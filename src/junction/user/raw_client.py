...
class RawUserClient:
    ...
    def get_connected_providers(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/providers/{encode_path_param(user_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_latest_user_info(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/info/latest",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def create_insurance(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/insurance",
            method="POST",
            json={
    ...
    def get_latest_insurance(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/insurance/latest",
            method="GET",
            params={
                "is_primary": is_primary,
            },
    ...
    def upsert_user_info(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/info",
            method="PATCH",
            json={
    ...
    def get_by_client_user_id(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/resolve/{encode_path_param(client_user_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def deregister_provider(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/{encode_path_param(provider)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def refresh(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/refresh/{encode_path_param(user_id)}",
            method="POST",
            params={
                "timeout": timeout,
            },
    ...
    def get_devices(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/device",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_device(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/device/{encode_path_param(device_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_user_sign_in_token(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/sign_in_token",
            method="POST",
            request_options=request_options,
        )
        try:
    ...
    def create_portal_url(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v2/user/{encode_path_param(user_id)}/create_portal_url",
            method="POST",
            json={
                "context": context,
                "order_id": order_id,
